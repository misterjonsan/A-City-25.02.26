...
function GM:ScoreboardShow()
	...
	muteallbut.Paint = function(self,w,h)
		surface.SetDrawColor( not hg.muteall and 234 or 0, hg.muteall and 255 or 0, not hg.muteall and 255 or 0, 128)
	...
	mutespectbut.Paint = function(self,w,h)
		surface.SetDrawColor( not hg.mutespect and 234 or 0, hg.mutespect and 255 or 0, not hg.mutespect and 255 or 0, 128)
        surface.DrawOutlinedRect( 0, 0, w, h, 2.5 )
	end
	...
	function DScrollPanel:Paint( w, h )
		...
		surface.SetDrawColor( 234, 0, 255, 128)
        surface.DrawOutlinedRect( 0, 0, w, h, 2.5 ) --ДОКТОР ОНО ОПЯТЬ НАЧАЛОСЬ!!!!!!!!
	end
	...
	for i, ply in player.Iterator() do -- надо это говно переделать.
		...
		but.Paint = function(self, w, h)
			if not IsValid(ply) then return end
			surface.SetDrawColor(115, 0, 126, colBlueUp.a)
			surface.DrawRect(0, 0, w, h)
			surface.SetDrawColor(106, 0, 116, colBlue.a) 
