...
SWEP.PrintName = "Steyr-Mannlicher SSG 08" --СДЕЛАЙ ССГ!!! ИДИ НАХОЙ LAGAET PIZDA
SWEP.Author = "Rench zaebal menya"
SWEP.Instructions = "The Steyr SSG 08 is an Austrian bolt-action sniper rifle developed and produced by Steyr. The rifle is a further evolution of Steyr’s earlier SSG 04 sniper rifle."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_shot_m3super90.mdl"
SWEP.WorldModelFake = "models/weapons/arccw_go/v_snip_ssg08.mdl"
